...
const (
	ReportService_GenerateReport_FullMethodName = "/ReportService/GenerateReport"
	ReportService_HealthCheck_FullMethodName    = "/ReportService/HealthCheck"
)
...
func (UnimplementedReportServiceServer) GenerateReport(context.Context, *UserRequest) (*ReportResponse, error) {
